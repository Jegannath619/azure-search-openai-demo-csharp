...
public enum EmbeddingType
{
	...
	/// <summary>
	/// Embed using the Mongo Atlas Vector Database
	/// See <a href='https://www.mongodb.com/products/platform/atlas-vector-search'>https://www.mongodb.com/products/platform/atlas-vector-search</a>
	/// </summary>
	Mongo = 4
};
